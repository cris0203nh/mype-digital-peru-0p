    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-3xl px-4 text-center md:px-6">
        ...
        <p className="mt-2 text-muted-foreground">
          Únete a nuestra comunidad y recibe consejos, herramientas y capacitaciones para hacer
          crecer tu MYPE.
        </p>
          ...
          {NETWORKS.map((network) => {
            ...
            return (
              <a
                key={network.name}
                href={network.href}
                className="flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2.5 text-sm font-medium text-foreground shadow-sm transition-colors hover:border-primary/40 hover:text-primary"
              >
